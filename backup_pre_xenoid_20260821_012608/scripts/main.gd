...
const FONDOS := {
	...
	# Temporal: hasta crear arena propia de Xenoid.
	"Xenoid": "res://assets/fondos/cibor-x.jpg",
}
...
func _crear_ui() -> void:
	...
	ayuda2.text = "Rival: 1 Fang  2 Cibor-X  3 Kali  4 Aethel  5 Magnus  6 Helena  7 Jester  8 Varkhos  9 Xenoid"
	ayuda2.position = Vector2(40, 684)
	capa.add_child(ayuda2)

	seleccion_jugador_label = Label.new()
	seleccion_jugador_label.text = "J1: Q Kai  W Fang  E Cibor-X  R Kali  T Aethel  Y Magnus  U Helena  I Jester  O Xenoid"
