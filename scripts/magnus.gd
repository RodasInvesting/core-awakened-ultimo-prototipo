...
func _init() -> void:
	...
	texturas_patada_extra = [
		...
		load("res://assets/magnus/patada_6_90_10_67.png"),
	...
	textura_absoluto = load("res://assets/magnus/gigantografia_core3_nueva.png")
	...
	# 90.10.67 — los 4 nuevos sprites Furia se agregan al FINAL del
	# repertorio que usa el combo automático de Magnus. Magnus conserva
	# combo_auto_incluye_patada = false, por eso se cargan aquí como
	# secuencia visual para garantizar que los cuatro aparezcan en CORE III.
	texturas_furia_punetazo_extra = [
		...
		load("res://assets/magnus/furia_combo_7_90_10_67.png"),
		load("res://assets/magnus/furia_combo_8_90_10_67.png"),
		load("res://assets/magnus/furia_combo_9_90_10_67.png"),
		load("res://assets/magnus/furia_combo_10_90_10_67.png"),
	]
	...
	# 91.02.51 — PASS 12H / PROYECTIL TANDA 2 — MAGNUS.
	proyectil_especial_habilitado = true
	textura_proyectil_pose = load("res://assets/magnus/poder_proyectil.png")
	textura_proyectil_nucleo = load("res://assets/magnus/proyectil_oficial.png")
	proyectil_pose_escala_mult = 1.05
	# 91.02.52 — Magnus es 1.15x más alto visualmente; con el spawn 0.54
	# el proyectil nacía demasiado alto y su hitbox fina podía pasar por encima.
	# 0.47 lo devuelve a la misma línea de pecho que el roster estándar.
	proyectil_spawn_altura_mult = 0.47
	color_proyectil_primario = Color(0.05, 0.62, 1.0, 1.0)
	color_proyectil_secundario = Color(0.78, 0.96, 1.0, 1.0)
