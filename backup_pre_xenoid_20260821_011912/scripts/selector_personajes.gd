...
# FASE XENOID — selector visual definitivo (WIP Varkhos)
# La ilustración ya contiene el título, los 9 luchadores seleccionables y
# Varkhos encadenado/bloqueado. Varkhos NO forma parte de este ROSTER y no
# recibe zona de click: el bloqueo es visual Y lógico.
...
# Bordes medidos sobre selector_personajes_nuevo.png (1280x720).
# Hay 10 tarjetas visibles; solamente las primeras 9 son seleccionables.
